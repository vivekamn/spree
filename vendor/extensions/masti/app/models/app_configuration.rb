class AppConfiguration < Configuration
  ...
  preference :site_name, :string, :default => 'Masthi Deals'
  preference :site_url, :string, :default => 'http://www.masthideals.com'
  preference :enable_mail_delivery, :boolean, :default => false
  preference :mail_host, :string, :default => 'smtp.sendgrid.net'
  preference :mail_domain, :string, :default => 'sitterscout.com'
  preference :mail_port, :integer, :default => 25
  preference :mail_auth_type, :string, :default => MAIL_AUTH[0] 
  preference :smtp_username, :string, :default => "notifications@sitterscout.com"
  preference :smtp_password, :string, :default => "chiefscout"
