...
class MastiExtension < Spree::Extension
  ...
  def activate
    ...
    Product.class_eval do
      belongs_to :vendor
       attr_accessible :meta_description,:meta_keywords,:deal_info,:voucher_text,:vendor_id,:minimum_number,:deal_expiry_date,:reviews,:currently_bought_count,:description, :catch_message, :validity_from, :validity_to, :name, :price, :sku, :count_on_hand, :available_on, :discount, :increased_count, :maximum_number
